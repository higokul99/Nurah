                ...
                <div class="space-y-4">
                    ...
                    <div class="border border-green-200 rounded-lg p-4 bg-green-50/30">
                        ...
                        <div class="grid grid-cols-3 gap-3 pl-7">
                            <div>
                                <label class="block text-xs font-medium text-gray-500 mb-1">Stock</label>
                                <input type="number" value="120" class="w-full px-2 py-1.5 border border-gray-300 rounded text-sm focus:ring-green-500 focus:border-green-500" placeholder="0">
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-500 mb-1">Price</label>
                                <div class="relative rounded-md shadow-sm">
                                    ...
                                    <input type="text" value="4200.00" class="w-full pl-6 px-2 py-1.5 border border-gray-300 rounded text-sm focus:ring-green-500 focus:border-green-500" placeholder="0.00">
                                </div>
                            </div>
                            <div>
                                <label class="block text-xs font-medium text-gray-500 mb-1">Compare At</label>
                                <div class="relative rounded-md shadow-sm">
                                    ...
                                    <input type="text" value="5500.00" class="w-full pl-6 px-2 py-1.5 border border-gray-300 rounded text-sm focus:ring-green-500 focus:border-green-500" placeholder="0.00">
                                </div>
                            </div>
                        </div>
                    </div>
