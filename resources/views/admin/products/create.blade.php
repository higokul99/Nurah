            ...
            <div class="card bg-white rounded-lg border border-gray-200 shadow-sm p-4">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm" placeholder="e.g. Lemon, Bergamot">
                    </div>
                     <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Heart Notes</label>
                        <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm" placeholder="e.g. Rose, Jasmine">
                    </div>
                     <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Base Notes</label>
                        <input type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm" placeholder="e.g. Oud, Amber">
                    </div>
                </div>
            </div>
